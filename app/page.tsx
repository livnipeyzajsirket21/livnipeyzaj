...
export default function Home() {
  ...
  const teklifFormGonder = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const mesaj = [
      "Merhaba, mini teklif formunu doldurdum.",
  ...
  const teklifMailGonder = () => {
    ...
    const mailto = `mailto:info@livnipeyzaj.com?subject=${encodeURIComponent("Mini Teklif Talebi")}&body=${encodeURIComponent(mesaj)}`;
      ...
      <main className="min-h-screen font-sans">
        ...
        {menuAcik && (
          <div className="fixed top-[80px] left-0 right-0 z-40 bg-white border-b border-gray-100 flex flex-col items-center gap-5 py-6 md:hidden text-gray-700 font-medium shadow-lg">
            ...
            <a href="#iletisim" onClick={() => setMenuAcik(false)} className="bg-[#183325] text-white px-8 py-3 rounded-full hover:bg-[#1d3729] transition shadow-sm mt-2">
              Teklif İste
            </a>
          </div>
        )}
